<template>
    <section>
        <h1 class="p-4 md:px-14 text-2xl font-bold">List Order</h1>
        <div class="w-full md:pl-14 md:pr-10 px-4 relative">
            <label for="search" class="absolute top-1/2 z-10 -translate-y-1/2 md:left-16 left-6">
                <font-awesome-icon icon="fa-solid fa-magnifying-glass"/>
            </label>
            <input type="text" class="input w-full pl-8" id="search" name="search" placeholder="search order...">
        </div>
